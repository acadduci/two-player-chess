    ...
    def _draw_squares(self):
        for row in range(8):
            for col in range(8):
                ...
                color = self.light_color if self.board[row][col] == 0 else self.dark_color
                pg.draw.rect(self.game.screen, color, (x,y, self.square_size, self.square_size))
                pg.draw.rect(self.game.screen, pg.Color('black'), (x,y,self.square_size, self.square_size), 1)
